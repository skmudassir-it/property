      ...
      <div className="container mx-auto px-6 max-w-3xl relative z-10">
        ...
        {isSubmitted ? (
          <motion.div 
            ...
            className="text-center p-12 border border-white/10 bg-white/5 rounded-sm"
          >
            <h3 className="font-serif text-3xl text-white mb-4">Information Recorded</h3>
            <p className="text-white/60 font-light font-sans">
              Thank you for your interest. A member of our concierge team will be in touch with you shortly to coordinate your private viewing.
            </p>
          </motion.div>
        ) : (
          <>
